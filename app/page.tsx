...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Bongers.com - Nature's Touch!</title>
        <meta name="description" content="Welcome to Bongers.com" />
        <link rel="icon" href="/favicon.ico" />

      </Head>
      <Navbar />
      <div>
        <img src="/home.png" alt="Banner Image" width="100%" height="500px" />
      </div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-5xl text-4xl font-extrabold title-font text-gray-900 leading-tight">
              Wear Nature.<br />Own the Edge.
            </h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-400 mt-4">Streetwear crafted with raw comfort, bold design, and natural attitude.</p>
          </div>
          ...
          <p className="mt-4 text-sm text-gray-400 text-center">
            Free shipping • Easy returns • Premium fabrics
          </p>
        </div>
      </section>
      <Footer />
